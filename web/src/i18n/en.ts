...
export const en = {
  ...
  "buckling.shape.title": "Buckling mode (relative deflection)",
  "buckling.shape.aria": "Contour plot of the critical buckling mode",
  "buckling.shape.relativeDeflection": "Relative deflection",
  "buckling.shape.hint": "Shown to the plate's own aspect ratio. Colour is the sign and size of the out-of-plane deflection; only its SHAPE is meaningful, since a buckling mode has no absolute amplitude.",
