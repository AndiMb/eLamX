...
export const de: Messages = {
  ...
  "buckling.shape.title": "Beulform (relative Auslenkung)",
  "buckling.shape.aria": "Konturdarstellung der kritischen Beulform",
  "buckling.shape.relativeDeflection": "Relative Auslenkung",
  "buckling.shape.hint": "Im Seitenverhältnis der Platte dargestellt. Die Farbe zeigt Vorzeichen und Größe der Auslenkung; aussagekräftig ist nur die FORM, denn eine Beulform hat keine absolute Amplitude.",
